...
- lz-central-network.json::StrictFirewallPolicy -> centralNetworkServices.networkFirewall.policies[MYSLZ-strict-fw-policy]
...
- /Users/badenh/claudetemp/my-convert-lz2lza/sample-malaysia-secure-lz/cloudformation/network/firewall-suricata-rules.txt::<file> -> copied verbatim → firewall-rules/suricata-rules.txt
