...
- lz-organization-kms-iam.json::CloudWatchLogsKey -> keyManagementService.keySets[cloudwatch-logs-key]
- lz-organization-kms-iam.json::CloudWatchLogsKeyAlias -> attached to KeyConfig (implicit)
- lz-organization-kms-iam.json::ControlTowerBackupKey -> keyManagementService.keySets[control-tower-backup-key]
- lz-organization-kms-iam.json::ControlTowerBackupKeyAlias -> attached to KeyConfig (implicit)
...
- **lz-organization-kms-iam.json::EC2SSMServiceRole** — IAM role for KMS key access — engine-managed under LZA
